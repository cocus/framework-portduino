/*
  WiFiClientSecure.h - Base class that provides Client SSL using mbedtls
...
protected:
  ...
  // esp compat
  bool _connected;
  unsigned long _lastReadTimeout;
  unsigned long _lastWriteTimeout;
...
public:
  ...
  virtual int getSocketOption(int level, int option, const void *value, size_t size);
